...
packages:
  ...
  /hexo-front-matter/2.0.0:
    resolution: {integrity: sha512-IR3tjAyK2Ga/0a/WDAoNy5+n3ju2/mkuAsCDEeGgGLf5+7kkiOkkG/FrnueuYgz0h2MPfWDLBiDsSTCmB0sLCA==}
    engines: {node: '>=10.13.0'}
    dependencies:
      js-yaml: 3.14.1
    dev: false
  ...
  /hexo-renderer-ejs/1.0.0:
    resolution: {integrity: sha512-O925i69FG4NYO62oWORcPhRZZX0sPx1SXGKUS5DaR/lzajyiXH5i2sqnkj0ya0rNLXIy/D7Xmt7WbFyuQx/kKQ==}
    engines: {node: '>=8.6.0'}
    dependencies:
      ejs: 2.7.4
    dev: false
  ...
  /hexo-renderer-marked/4.1.0:
    resolution: {integrity: sha512-WnDiqv++VqXoQPBPEtb0KD3jhgjQXzgNHUyFWFMPH5uC0cGUMXJOdf/QmvfCjGqjL14z0EnSTpoKXqssUb//yQ==}
    engines: {node: '>=10.13.0'}
    dependencies:
      dompurify: 2.3.6
      hexo-util: 2.6.0
  ...
  /hexo/5.4.2:
    resolution: {integrity: sha512-Af6mxKwx9byalaffKgiQ8/bZfbXPo2SGEn2Q9hFh++15g15/IulvOhu8lQkJdyZNzmj3hOuSrJdqoUvIr3K/qw==}
    engines: {node: '>=10.13.0'}
    hasBin: true
    dependencies:
      abbrev: 1.1.1
